...
// Package gitops provides Git repository operations for Aotanami's auto-remediation
...
type Engine interface {
	...
	// ListOpenPRs returns open PRs created by Aotanami.
...
func PRTitle(resource, namespace, scanner string) string {
	return fmt.Sprintf("🛡️ [Aotanami] Fix %s findings in %s/%s", scanner, namespace, resource)
}
...
func PRBody(scanner, resource, namespace, description, llmAnalysis string) string {
	return fmt.Sprintf(`## 🛡️ Aotanami Automated Remediation
...
---
*This PR was automatically created by [Aotanami](https://github.com/aotanami/aotanami) — your autonomous Kubernetes security operator.*
